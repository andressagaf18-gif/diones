    ...
    return (
      <Card style={{marginBottom:16,borderLeft:"4px solid #176B47"}}>
        ...
        <div style={{
          ...
          <Linha titulo="FATURAMENTO MENSAL" valor={configSim.faturamentoMensal} formato="moeda" />
          <Linha titulo="CARGA ATUAL" valor={resultadoSim.atual} formato="moeda" />
          <Linha titulo="CENÁRIO REFORMA" valor={resultadoSim.reforma} formato="moeda" />
          <Linha titulo="DIFERENÇA" valor={resultadoSim.diferenca} formato="moeda" />
